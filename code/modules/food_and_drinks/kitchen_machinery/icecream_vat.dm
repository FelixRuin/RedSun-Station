...
/obj/machinery/icecream_vat/ui_interact(mob/user)
	...
	dat += "<b>Custom ice cream:</b> <a href='byond://?src=[REF(src)];select=[ICECREAM_CUSTOM]'><b>Select</b></a> <a href='byond://?src=[REF(src)];make=[ICECREAM_CUSTOM];amount=1'><b>Make</b></a> <a href='byond://?src=[REF(src)];make=[ICECREAM_CUSTOM];amount=5'><b>x5</b></a> [product_types[ICECREAM_CUSTOM]] dollops left. (Ingredients: milk, ice, optional flavoring)<br>"
	dat += "<a href='byond://?src=[REF(src)];custom_taste=1;'><b>Change custom taste: [custom_taste ? custom_taste : "Default"]</b></a>"
	dat += "<br><a href='byond://?src=[REF(src)];custom_color=1;'><b>Change custom color: [custom_color ? custom_color : "Default"]</b></a>"
	dat += "<br><a href='byond://?src=[REF(src)];reset_custom=1;'><b>Reset custom ice cream taste and color to defaults</b></a></div>"
