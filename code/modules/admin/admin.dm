...
//ambition end
	...
	body += "<a href='byond://?_src_=holder;[HrefToken()];newban=[REF(M)]'>Ban</A> | "
	body += "<a href='byond://?_src_=holder;[HrefToken()];jobban2=[REF(M)]'>Jobban</A> | "
	body += "<a href='byond://?_src_=holder;[HrefToken()];appearanceban=[REF(M)]'>Identity Ban</A> | "
	var/rm = REF(M)
	if(jobban_isbanned(M, "OOC"))
		body+= "<a href='byond://?_src_=holder;[HrefToken()];jobban3=OOC;jobban4=[rm]'><font color=red>OOCBan</font></A> | "
	else
		body+= "<a href='byond://?_src_=holder;[HrefToken()];jobban3=OOC;jobban4=[rm]'>OOCBan</A> | "
	if(QDELETED(M) || QDELETED(usr))
		return
	if(jobban_isbanned(M, "emote"))
		body+= "<a href='byond://?_src_=holder;[HrefToken()];jobban3=emote;jobban4=[rm]'><font color=red>EmoteBan</font></A> | "
	else
		body+= "<a href='byond://?_src_=holder;[HrefToken()];jobban3=emote;jobban4=[rm]'>Emoteban</A> | "
	if(QDELETED(M) || QDELETED(usr))
		return
	if(jobban_isbanned(M, "pacifist"))
		body+= "<a href='byond://?_src_=holder;[HrefToken()];jobban3=pacifist;jobban4=[rm]'><font color=red>PacifistBan</font></A> | "
	else
		body+= "<a href='byond://?_src_=holder;[HrefToken()];jobban3=pacifist;jobban4=[rm]'>PacifistBan</A> | "
...
//ambition start
	if(M.mind)
		body += " | <a href='byond://?_src_=holder;[HrefToken()];ObjectiveRequest=[REF(M.mind)]'>Objective-Ambition Menu</A>"
//ambition end
	...
	if (M.client)
		...
		body += "<a href='byond://?_src_=holder;[HrefToken()];makeeligible=[REF(M)]'>Allow reentering round</A>"
	body += "<br>"
	body += "</body></html>"
...
/datum/admins/proc/dynamic_mode_options(mob/user)
	var/dat = {"<meta http-equiv='Content-Type' content='text/html; charset=utf-8'>
		...
		<br/>
		<b>Round Type:</b> - Current one is <a href='byond://?src=[REF(src)];[HrefToken()];f_round_type=1'> <b>[GLOB.round_type]</b></a>.
