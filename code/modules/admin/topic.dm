...
//Regular jobs
	//Command (Blue)
		...
		dat += "<tr align='center' bgcolor='ccccff'><th colspan='[length(GLOB.command_positions)]'><a href='byond://?src=[REF(src)];[HrefToken()];jobban3=commanddept;jobban4=[REF(M)]'>Command Positions</a></th></tr><tr align='center'>"
	...
	//Security (Red)
		counter = 0
		dat += "<table cellpadding='1' cellspacing='0' width='100%'>"
		dat += "<tr bgcolor='ffddf0'><th colspan='[length(GLOB.security_positions)]'><a href='byond://?src=[REF(src)];[HrefToken()];jobban3=securitydept;jobban4=[REF(M)]'>Security Positions</a></th></tr><tr align='center'>"
	...
	//Engineering (Yellow)
		counter = 0
		dat += "<table cellpadding='1' cellspacing='0' width='100%'>"
		dat += "<tr bgcolor='fff5cc'><th colspan='[length(GLOB.engineering_positions)]'><a href='byond://?src=[REF(src)];[HrefToken()];jobban3=engineeringdept;jobban4=[REF(M)]'>Engineering Positions</a></th></tr><tr align='center'>"
	...
	//Medical (White)
		counter = 0
		dat += "<table cellpadding='1' cellspacing='0' width='100%'>"
		dat += "<tr bgcolor='ffeef0'><th colspan='[length(GLOB.medical_positions)]'><a href='byond://?src=[REF(src)];[HrefToken()];jobban3=medicaldept;jobban4=[REF(M)]'>Medical Positions</a></th></tr><tr align='center'>"
	...
	//Science (Purple)
		counter = 0
		dat += "<table cellpadding='1' cellspacing='0' width='100%'>"
		dat += "<tr bgcolor='e79fff'><th colspan='[length(GLOB.science_positions)]'><a href='byond://?src=[REF(src)];[HrefToken()];jobban3=sciencedept;jobban4=[REF(M)]'>Science Positions</a></th></tr><tr align='center'>"
	...
	//Supply (Brown)
		counter = 0
		dat += "<table cellpadding='1' cellspacing='0' width='100%'>"
		dat += "<tr bgcolor='DDAA55'><th colspan='[length(GLOB.supply_positions)]'><a href='byond://?src=[REF(src)];[HrefToken()];jobban3=supplydept;jobban4=[REF(M)]'>Supply Positions</a></th></tr><tr align='center'>"
	...
	//Civilian (Grey)
		counter = 0
		dat += "<table cellpadding='1' cellspacing='0' width='100%'>"
		dat += "<tr bgcolor='dddddd'><th colspan='[length(GLOB.civilian_positions)]'><a href='byond://?src=[REF(src)];[HrefToken()];jobban3=civiliandept;jobban4=[REF(M)]'>Civilian Positions</a></th></tr><tr align='center'>"
	...
	//Law (Crimson)
		counter = 0
		dat += "<table cellpadding='1' cellspacing='0' width='100%'>"
		dat += "<tr bgcolor='7e3d48'><th colspan='[length(GLOB.law_positions)]'><a href='byond://?src=[REF(src)];[HrefToken()];jobban3=lawdept;jobban4=[REF(M)]'>Law Positions</a></th></tr><tr align='center'>"
	...
	//Antagonist (Orange)
		...
		if(jobban_isbanned(M, ROLE_HERETIC) || isbanned_dept)
			dat += "<td width='20%'><a href='byond://?src=[REF(src)];[HrefToken()];jobban3=heretic;jobban4=[REF(M)]'><font color=red>Heretic</font></a></td>"
		else
			dat += "<td width='20%'><a href='byond://?src=[REF(src)];[HrefToken()];jobban3=heretic;jobban4=[REF(M)]'>Heretic</a></td>"
		...
		if(jobban_isbanned(M, ROLE_FAMILIES) || isbanned_dept)
			dat += "<td width='20%'><a href='byond://?src=[REF(src)];[HrefToken()];jobban3=gang;jobban4=[REF(M)]'><font color=red>Families</font></a></td>"
		else
			dat += "<td width='20%'><a href='byond://?src=[REF(src)];[HrefToken()];jobban3=gang;jobban4=[REF(M)]'>Families</a></td>"
		//Bloodsucker
		...
		if(jobban_isbanned(M, ROLE_SLAVER) || isbanned_dept)
			dat += "<td width='20%'><a href='byond://?src=[REF(src)];[HrefToken()];jobban3=slaver;jobban4=[REF(M)]'><font color=red>Slaver</font></a></td>"
		else
			dat += "<td width='20%'><a href='byond://?src=[REF(src)];[HrefToken()];jobban3=slaver;jobban4=[REF(M)]'>Slaver</a></td>"
	...
	//Other Roles (black)
		...
		if(jobban_isbanned(M, ROLE_RESPAWN))
			dat += "<td width='20%'><a href='byond://?src=[REF(src)];[HrefToken()];jobban3=[ROLE_RESPAWN];jobban4=[REF(M)]'><font color=red>Respawns</font></a></td>"
		else
			dat += "<td width='20%'><a href='byond://?src=[REF(src)];[HrefToken()];jobban3=[ROLE_RESPAWN];jobban4=[REF(M)]'>Respawns</a></td>"
