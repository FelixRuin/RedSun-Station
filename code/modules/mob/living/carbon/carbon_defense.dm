	...
	for(var/X in bodyparts)
		...
		for(var/obj/item/I in LB.embedded_objects)
			...
			if(I.isEmbedHarmless())
				output += "\n\t <a href='byond://?src=[REF(src)];embedded_object=[REF(I)];embedded_limb=[REF(LB)]' class='warning'>[I] врезался в вашу конечность - [LB.ru_name]!</a>"
			else
				output += "\n\t <a href='byond://?src=[REF(src)];embedded_object=[REF(I)];embedded_limb=[REF(LB)]' class='warning'>[I] застрял в вашей конечности - [LB.ru_name]!</a>"
