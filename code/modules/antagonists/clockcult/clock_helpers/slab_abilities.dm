...
/obj/effect/proc_holder/slab/InterceptClickOn(mob/living/clicker, params, atom/target)
	if(..() || in_progress)
		return TRUE
...
/obj/effect/proc_holder/slab/hateful_manacles/InterceptClickOn(mob/living/clicker, params, atom/target)
	if(..())
		return TRUE
...
/obj/effect/proc_holder/slab/compromise/InterceptClickOn(mob/living/clicker, params, atom/target)
	if(..())
		return TRUE
...
/obj/effect/proc_holder/slab/volt/InterceptClickOn(mob/living/clicker, params, atom/target)
...
/obj/effect/proc_holder/slab/kindle/InterceptClickOn(mob/living/clicker, params, atom/target)
	if(..())
		return TRUE
	...
	if(target in view(7, get_turf(ranged_ability_user)))
		...
		A.preparePixelProjectile(target, clicker, params)
		A.fire()
...
/obj/effect/proc_holder/slab/vanguard/InterceptClickOn(mob/living/clicker, params, atom/target)
	if(..())
		return TRUE
...
/obj/effect/proc_holder/slab/judicial/InterceptClickOn(mob/living/clicker, params, atom/target)
	if(..())
		return TRUE
