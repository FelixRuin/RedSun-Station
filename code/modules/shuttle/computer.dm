...
/obj/machinery/computer/shuttle/ui_act(action, params)
	...
	switch(action)
		...
		if("request")
			...
			to_chat(GLOB.admins, "<b>FERRY: <font color='#3d5bc3'>[ADMIN_LOOKUPFLW(usr)] (<a href='byond://?_src_=holder;[HrefToken()];secrets=movepod'>Move Pod</a>)</b> is requesting to move the transport Escape Pod.</font>")
			return TRUE
